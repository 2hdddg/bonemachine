...
module.exports.create = function(centralProxy, agentProxy){
    ...
    function allocate(requirements, serviceDescription, callback){
        ...
        centralProxy.allocate(requirements, serviceDescription, callback);
        /*
        callback(null, {
    ...
    function install(servicePath, requirements, installCallback){
        async.waterfall([
            ...
            function (result, callback){
                getPackage(servicePath, function(error, packageStream){
                    if (error){
                    ...
                    callback(null, _.assign(result, { packageStream: packageStream}));
                });
            },
            ...
            function(result, callback){
                uploadPackage(result.packageStream, result.serviceProxy, function(error){
                    if (error){
